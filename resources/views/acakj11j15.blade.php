    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                // Panggilan API
                $data = file_get_contents('https://muslimapp.elghifari.site/api/quran/ayat/acak/juz11-15');
                $response = json_decode($data, true);
                // Tampilkan data dalam tampilan Blade
                ?>
                <div class="text-center text-black text-14xl font-bold">
                    <strong>ACAK JUZ 11 - 15</strong>
                    <p>{{ $response['info']['surat']['id'] }} : {{ $response['data']['ayah'] }} /
                        J{{ $response['data']['juz'] }} : H{{ $response['data']['page'] }}</p>
                </div>
