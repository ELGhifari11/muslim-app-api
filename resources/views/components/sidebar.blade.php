<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.html">EL MUSLIM APP </a>
        </div>
        <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.html">St</a>
        </div>
        <ul class="sidebar-menu">
            <li class="menu-header">Dashboard - EL MUSLIM APP</li>
            <li class="nav-item dropdown {{ $type_menu === 'dashboard' ? 'active' : '' }}">
                <a href="#"
                    class="nav-link has-dropdown"><i class="fas fa-book"></i><span>Al-Qur'an</span></a>
                <ul class="dropdown-menu">
                    <li class='{{ Request::is('random-quran-by-juz') ? 'active' : '' }}'>
                        <a class="nav-link"
                            href="{{ url('random-quran-by-juz') }}">Random Ayat</a>
                    </li>
                    {{-- <li class='{{ Request::is('') ? 'active' : '' }}'>
                        <a class="nav-link"
                            href="{{ url('random-quran-by-juz') }}">Random By Range Juz</a>
                    </li> --}}
        ...
        <div class="hide-sidebar-mini mt-4 mb-4 p-3">
            <a href="https://www.instagram.com/el.g.11"
                class="btn btn-primary btn-lg btn-block btn-social-icon btn-instagram">
                <i class="fab fa-instagram mr-2"></i> My Instagram
            </a>
        </div>
    </aside>
</div>
